...
Стек: `sklearn`, `spacy`, `torch`, `seaborn`, `numpy`, `pandas`, `wordcloud`, `nltk`, `sklearn.feature_extraction`

__В рассматриваемом наборе текстов встречается обсценная лексика!__
